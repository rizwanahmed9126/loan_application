              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text('Proof of work/address',style: GoogleFonts.montserrat(fontSize: 23,letterSpacing: 2,fontWeight: FontWeight.bold),),
                    SizedBox(height: height*0.05,),
                    Container(
                        width: width*0.8,
                ...
                Container(
                  height: height*0.1,
                    ...
                    Icon(Icons.cloud_upload,size:75, color: Color(0xFFE0E1E0),)
                    ),
            Container(
              height: height*0.06,
              width: width*0.45,
